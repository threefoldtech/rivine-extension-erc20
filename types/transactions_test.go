...
func TestJSONExampleERC20ConvertTransaction(t *testing.T) {
	const erc20CoinConvertTransactionVersion types.TransactionVersion = 208
	types.RegisterTransactionVersion(erc20CoinConvertTransactionVersion, ERC20ConvertTransactionController{TransactionVersion: erc20CoinConvertTransactionVersion})
	defer types.RegisterTransactionVersion(erc20CoinConvertTransactionVersion, nil)

	jsonEncodedExample := fmt.Sprintf(`{
	"version": %d,
	"data": {
...
}`, erc20CoinConvertTransactionVersion)
...
func TestJSONExampleERC20CoinCreationTransaction(t *testing.T) {
	const erc20CoinCreationTransactionVersion types.TransactionVersion = 209
	types.RegisterTransactionVersion(erc20CoinCreationTransactionVersion, ERC20CoinCreationTransactionController{TransactionVersion: erc20CoinCreationTransactionVersion})
	defer types.RegisterTransactionVersion(erc20CoinCreationTransactionVersion, nil)
...
func TestJSONExampleERC20AddressRegistrationTransaction(t *testing.T) {
	const erc20AddressRegistrationTransactionVersion types.TransactionVersion = 210
	types.RegisterTransactionVersion(erc20AddressRegistrationTransactionVersion, ERC20AddressRegistrationTransactionController{TransactionVersion: erc20AddressRegistrationTransactionVersion})
	defer types.RegisterTransactionVersion(erc20AddressRegistrationTransactionVersion, nil)

	jsonEncodedExample := fmt.Sprintf(`{
	"version": %d,
	"data": {
		"pubkey": "ed25519:a271b9d4c1258f070e1e8d95250e6d29f683649829c2227564edd5ddeb75819d",
		"address": "01b49da2ff193f46ee0fc684d7a6121a8b8e324144dffc7327471a4da79f1730960edcb2ce737f",
...
}`, erc20AddressRegistrationTransactionVersion)
