...
func TestJSONExampleERC20ConvertTransaction(t *testing.T) {
	...
	types.RegisterTransactionVersion(208, ERC20ConvertTransactionController{})
	defer types.RegisterTransactionVersion(208, nil)
...
func TestJSONExampleERC20CoinCreationTransaction(t *testing.T) {
	// define tfchain-specific transaction versions
	types.RegisterTransactionVersion(209, ERC20CoinCreationTransactionController{})
	defer types.RegisterTransactionVersion(209, nil)
...
func TestJSONExampleERC20AddressRegistrationTransaction(t *testing.T) {
	// define tfchain-specific transaction versions
	types.RegisterTransactionVersion(210, ERC20AddressRegistrationTransactionController{})
	defer types.RegisterTransactionVersion(210, nil)
